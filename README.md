...
Swahili is spoken by 100-150 million people across East Africa. In Tanzania and Kenya, it is one of two national languages (the other is English) and it is the official language of instruction in all schools. News in Swahili is an important part of the media sphere in Tanzania amd Kenya.
...
```bash
git clone https://github.com/tusiimegeorge/Artificial-intelligence
```
